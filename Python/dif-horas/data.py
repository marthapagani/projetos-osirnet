...
def diferenca_horas(hora1, hora2, data1, data2):
    try:
        ...
        print(f'Diferença: {horas} horas e {minutos} minutos.')

    except ValueError:
        print("Formato inválido. Certifique-se de usar o formato 'DIA-MES-ANO e HORA:MINUTO:SEGUNDO'.")

if __name__ == "__main__":
    data_inicio = input("Digite a data de início (formato DIA-MES-ANO): ")
    hora_inicio = input("Digite a hora de início (formato HORA:MINUTO:SEGUNDO): ")
    
    data_fim = input("Digite a data de término (formato DIA-MES-ANO): ")
    hora_fim = input("Digite a hora de término (formato HORA:MINUTO:SEGUNDO): ")
